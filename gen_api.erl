...
api_list(Version, Wordsize, HasDirtySchedulers)
  when Version =:= {2,7};
    ...
    {"ERL_NIF_TERM", "enif_schedule_nif", "env: *mut ErlNifEnv, fun_name: *const c_uchar, flags:c_int, dtor: Option<extern \"C\" fn(env: *mut ErlNifEnv, argc:c_int, argv:*const ERL_NIF_TERM) -> ERL_NIF_TERM>, argc:c_int, argv:*const ERL_NIF_TERM"}
    ] ++
